...
import type { BreakdownStat, CategoryStat, MonthlyStat, StatisticsType } from './types';
...
export const { useGetMonthlyQuery, useGetCategoriesQuery, useGetBreakdownQuery } = statisticsApi;
